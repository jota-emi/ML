...
class laser_feature:
   ...
   neuronios = pd.read_csv("https://raw.githubusercontent.com/jota-emi/ML/master/BaseSOMv1.csv")
   ...
   def callback(self, ros_data):
       ...
       for i in range (len(self.x)):
           distancias.append(distance.euclidean(novodado,self.x[i]))
       neuroVenc = distancias.index(min(distancias))
       self.key = self.y[neuroVenc]
       print(neuroVenc)
       print(self.key)
        # Publish new info
